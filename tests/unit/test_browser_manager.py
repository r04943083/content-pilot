...
class TestBrowserReuse:
    @pytest.mark.asyncio
    async def test_always_launches_new_browser(self, manager):
        """Each get_context launches a fresh browser (matching main branch behavior)."""
        ...
        assert manager._browser is new_browser
